...
Route::prefix('/')->group(function () {
    ...
    Route::get('clientesFiscView', [ClientesController::class, 'clientesFiscView'])->name('clientes_fisico_vista');
    ...
    Route::get('consultarClientesM', [ClientesController::class, 'consultarClientesM'])->name('consultarClientesM');
